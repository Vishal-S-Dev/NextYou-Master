 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.nextyou.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.ios.nextyou'; // ios bundle id
const PACKAGE = 'com.android.nextyou'; // android package name
const NAME = 'NextYou'; // app name
const EXPO_ACCOUNT_OWNER = 'parag1990'; // expo account owner
const EAS_PROJECT_ID = '55ea1d93-bcab-4711-b025-8deaa3443b28'; // eas project id
const SCHEME = 'NextYou'; // app scheme
...
const withEnvSuffix = (name) => {
  console.log(APP_ENV === 'production' ? name : `${name}.${APP_ENV}`);
  return APP_ENV === 'production' ? name : `${name}.${APP_ENV}`;
};

// Helper for env-based file paths
// const withEnvFile = (base, ext) => {
//   return path.resolve(__dirname, `./${base}.${APP_ENV}.${ext}`);
// };
